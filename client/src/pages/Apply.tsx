...
export default function Apply() {
      ...
      <Layout>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
          <Card className="max-w-lg w-full text-center p-8">
            ...
            <h2 className="text-2xl font-bold text-[var(--luxe-navy)] mb-3">Application Submitted!</h2>
            ...
            <a href="/" className="inline-block bg-[var(--luxe-gold)] hover:bg-[var(--luxe-gold)]/90 text-[var(--luxe-navy)] font-semibold px-6 py-3 rounded-lg transition-colors">
              Return to Home
            </a>
          </Card>
        </div>
  ...
  return (
    <Layout>
      <section className="bg-[var(--luxe-navy)] text-white py-16">
        <div className="container text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Rental Application</h1>
          <p className="text-xl max-w-2xl mx-auto text-white/80">
            Complete the form below to apply for a rental property. A ${APPLICATION_FEE} application fee covers processing and a background/credit check.
          </p>
        </div>
      </section>
